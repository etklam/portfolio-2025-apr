        ...
        <div className="flex justify-around mt-4">
          ...
          <a href="https://twitter.com" className="text-accent-secondary hover:text-accent-primary" target="_blank" rel="noopener noreferrer">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path d="M23 3a10.9 10.9 0 01-3.14 1.53A4.48 4.48 0 0016.11 3c-2.63 0-4.77 2.14-4.77 4.77 0 .37.04.74.12 1.09-3.97-.2-7.49-2.1-9.84-4.99-.41.7-.64 1.5-.64 2.36 0 1.63.83 3.07 2.1 3.91a4.49 4.49 0 01-2.16-.6v.06c0 2.28 1.62 4.19 3.77 4.62-.39.11-.79.17-1.21.17-.3 0-.58-.03-.86-.08.58 1.82 2.26 3.14 4.25 3.18A9 9 0 012 19.54a12.73 12.73 0 006.88 2.01c8.26 0 12.79-6.85 12.79-12.79 0-.2 0-.39-.01-.58A9.14 9.14 0 0023 3z" />
            </svg>
          </a>
