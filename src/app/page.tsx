            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="mt-8">
                <a
                  ...
                  className="inline-flex items-center text-lg text-indigo-600 hover:text-indigo-700 transition-colors mr-6"
                >
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">A showcase of my work and skills</p>
